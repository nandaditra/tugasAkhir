            ...
            <div class="col-6">
              <form class="shadow p-3 mb-5 mt-4 bg-body rounded"action="" method="POST">
                ...
                <div class="mb-3 row mt-5">
                    <label for="nomorTelepon" class="col-sm-5 col-form-label">Upload Informasi Kontak</label>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="d-grid gap-2 col-sm-6">
                        <button type="button" class="btn btn-danger text-white"name= "submit2" value="submit2">Ulangi Semua</button>
                    </div>
                </div>
...
if(isset($_POST['submit1'])){
  header("location:uploadKontak.php");	
  }
